...
*   **`1.点我开始登录.bat`**：**换电脑后的第一次操作**。双击它登录你的 Atlassian 账号（Jira/Confluence 账号）。
*   **`2.点我开始和AI聊天.bat`**：平时双击它，就能弹出一个窗口跟 AI 聊天。
*   **`安装或更新程序.bat`**：如果程序坏了或者想用最新版，双击它会自动下载。
*   **`使用说明.md`**：就是你现在看的这份文档。
...
3.  **开始聊天**：在项目的文件夹里，双击那个 **`2.点我开始和AI聊天.bat`**。
...
*   **换了台电脑又要登录？** 是的，每台新电脑需要先运行一次 `1.点我开始登录.bat`。
